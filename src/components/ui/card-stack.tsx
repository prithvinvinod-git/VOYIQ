  ...
  return (
    ...
    >
      <div
        ...
        style={{ height: Math.max(340, cardHeight + 48) }}
        tabIndex={0}
        onKeyDown={onKeyDown}
        role="region"
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? "w-6 bg-primary" : "w-2 bg-foreground/25 hover:bg-foreground/50"
                  )}
                />
              );
            })}
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-6">
        ...
        <div className="truncate text-xl font-bold text-white font-headline">{item.title}</div>
        {item.description && (
          <div className="mt-1.5 line-clamp-2 text-sm text-white/75">{item.description}</div>
        )}
      </div>
    </div>
  );
