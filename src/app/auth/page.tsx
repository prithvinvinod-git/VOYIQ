...
import { Compass, Mail, Phone, Lock, ArrowRight, Loader2 } from "lucide-react";
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: error.message || "Please ensure Google Auth is enabled in the Firebase Console.",
      });
    } finally {
      setLoading(false);
    }
