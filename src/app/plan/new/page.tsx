...
export default function TripWizard() {
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.currency || !formData.totalBudget) {
      toast({ variant: "destructive", title: "Missing Info", description: "Please set your budget and currency." });
      return;
    }
    setLoading(true);
    try {
                  ...
                  <div className="glass-card p-6 rounded-2xl border border-primary/20 bg-primary/5">
                    <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="font-bold truncate">{formData.travelStyle.join(", ") || "None selected"}</p>
                      </div>
                    </div>
                  </div>
