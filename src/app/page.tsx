    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-headline font-extrabold mb-8 tracking-tighter animate-fade-in leading-tight" style={{ animationDelay: '0.1s' }}>
